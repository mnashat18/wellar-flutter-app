...
class _ManagerRequestsScreenState extends State<ManagerRequestsScreen> {
  ...
  void initState() {
    super.initState();
    _future = RequestService.instance.fetchManagerRequests();
  }
                ...
                if (snap.connectionState != ConnectionState.done) {
                  return ListView(
                    ...
                    children: const [
                      LuxHeader(
                        title: 'Team Requests',
                        subtitle: 'Team scan request operations',
                  ...
                  return ListView(
                    ...
                    children: [
                      ...
                      StatusCard(
                        ...
                        message: forbidden
                            ? 'You can view requests only if your role has access.'
                            : 'Unable to load team requests right now.',
                ...
                return RefreshIndicator(
                  ...
                  child: ListView(
                    ...
                    children: [
                      LuxHeader(
                        title: 'Team Requests',
                        subtitle: 'Track and assign team readiness checks',
                        icon: Icons.assignment_outlined,
                        onBack: () => Navigator.pop(context),
                        trailing: SecondaryButton(
                          text: 'Send Team Scan Request',
                      ...
                      if (_createUnavailable)
                        const Padding(
                          ...
                          child: AppCard(
                            ...
                            child: Text(
                              'You can view requests, but creating requests is unavailable for your role.',
                              style: TextStyle(
                      ...
                      if (data.isEmpty)
                        const EmptyStateCard(
                          title: 'No team scan requests yet.',
                          message:
      ...
      child: AppCard(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Target member: ${item.requestedForName ?? 'Team member'}',
  ...
  Future<void> _openRequestForm() async {
    final members = await ManagerOpsService.instance.fetchTeam();
    if (!mounted) return;
    if (members.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('No team members available.')),
      );
      return;
    }
    ...
    ManagerMemberView? selected = eligibleMembers.first;
    DateTime? dueAt;
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  DropdownButtonFormField<ManagerMemberView>(
